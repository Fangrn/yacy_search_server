package net.yacy.htroot.processing.domaingraph.applet;

import processing.core.*; import traer.physics.*; import traer.animation.*; import processing.net.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*;

import net.yacy.cora.util.CommonPattern; public class domaingraph extends PApplet {// Domain visualization graph for YaCy
// by Michael Christen
//
...
public void processCitation(String host, HashMap props) {
  ...
  try {
  String counts = (String) props.get("count"); 
  if (counts != null) {
