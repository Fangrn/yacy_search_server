...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "02zwhn546fksagq8c5ce0dfea04rgutanud72azhc76c2x3f52v0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "YaCy"),

    appVersion = 0,  # Increment this for every release.

    appMarketingVersion = (defaultText = "1.91"),
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/yacy/yacy_search_server",
      ...
      shortDescription = (defaultText = "Decentralized search engine"),
